 ...
 * base de dados para a entidade {@link TbUnidadePesquisa}.
 *
 * Todas as <b>Named Queries</b> ou <b>Queries Nativas</b>, referentes a entidade
 * {@link TbUnidadePesquisa}, deverão ser implementadas nesta interface.
 *
 * @author mamede
 * @version 0.0.1-SNAPSHOT
 */
@Repository
public interface UnidadePesquisaRepository extends JpaRepository<TbUnidadePesquisa, Long> {
}
